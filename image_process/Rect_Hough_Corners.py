...
class RectangleIntersectionDetector:
    ...
    def detect_intersection(self, image_path):
        ...
        if len(rectangles) >= 2:
            for rect in rectangles:
                ...
                # Get the shorter sides of the rectangle
                side1_mid, side2_mid = self.get_shorter_sides_midpoints(box)
    ...
    def get_shorter_sides_midpoints(self, box):
        # Get the midpoints of the shorter sides of the rectangle
        side1_mid = ((box[0][0] + box[1][0]) / 2, (box[0][1] + box[1][1]) / 2)
        side2_mid = ((box[1][0] + box[2][0]) / 2, (box[1][1] + box[2][1]) / 2)
    ...
    def find_intersection(self, rect1, rect2):
        ...
        # Get the midpoints of the shorter sides
        side1_mid1, side1_mid2 = self.get_shorter_sides_midpoints(corners1)
        side2_mid1, side2_mid2 = self.get_shorter_sides_midpoints(corners2)
